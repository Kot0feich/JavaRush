...
public class Solution {
    ...
    public static boolean isModifierSet(int allModifiers, int specificModifier) {
        //System.out.println(String.format("%8s",Integer.toBinaryString(allModifiers)).replaceAll(" ","0"));
        //System.out.println(String.format("%8s",Integer.toBinaryString(specificModifier)).replaceAll(" ","0"));
        return ((allModifiers&specificModifier) == 0 ? false : true);
    }
